...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="entry-content py-3">
        ...
        <p><?php echo do_shortcode('[gc_series paging_by="per_year" show_num_years_first_page="2" paging_init_year=' .
                                   date('Y') . ' per_page="12" remove_dates=false remove_thumbnail=false
                                   thumbnail_size="medium" number_columns="3" list_offset="1"
                                   wrap_classes="other-series" remove_pagination=false]'); ?></p>
