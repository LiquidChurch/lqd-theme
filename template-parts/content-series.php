<?php
/**
 * The template used for displaying message series
 *
 * @package WordPress
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="entry-content">
        ...
        <hr/>
        <p><?php echo do_shortcode('[lqdm_series paging_by="per_year" show_num_years_first_page="2" paging_init_year=' .
                                   date('Y', time()) .
