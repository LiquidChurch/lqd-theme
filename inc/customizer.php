 ...
 */
function liquidchurch_custom_header_and_background() {
...
if ( ! function_exists( 'liquidchurch_header_style' ) ) :
/**
 ...
 */
function liquidchurch_header_style() {
	...
	?>
	<style type="text/css" id="liquidchurch-header-css">
		.site-branding {
			margin: 0 auto 0 0;
		}
...
endif; // liquidchurch_header_style
 ...
 */
function liquidchurch_customize_register( $wp_customize ) {
	$color_scheme = liquidchurch_get_color_scheme();
 ...
 * @return void
 */
function liquidchurch_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function liquidchurch_customize_partial_blogdescription() {
	bloginfo( 'description' );
}

/**
 * Registers color schemes for Liquid Church.
 *
 * Can be filtered with {@see 'liquidchurch_color_schemes'}.
 *
 ...
 */
function liquidchurch_get_color_schemes() {
	/**
	 * Filter the color schemes registered for use with Liquid Church.
	 *
...
/**
 * Retrieves the current Liquid Church color scheme.
 *
...
endif; // liquidchurch_get_color_scheme

if ( ! function_exists( 'liquidchurch_get_color_scheme_choices' ) ) :
/**
 * Retrieves an array of color scheme choices registered for Liquid Church.
 *
...
endif; // liquidchurch_get_color_scheme_choices


if ( ! function_exists( 'liquidchurch_sanitize_color_scheme' ) ) :
/**
 * Handles sanitization for Liquid Church color schemes.
 *
 ...
 */
function liquidchurch_sanitize_color_scheme( $value ) {
	$color_schemes = liquidchurch_get_color_scheme_choices();
...
endif; // liquidchurch_sanitize_color_scheme
 ...
 */
function liquidchurch_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	wp_add_inline_style( 'liquidchurch-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'liquidchurch_color_scheme_css' );
...
add_action( 'customize_controls_print_footer_scripts', 'liquidchurch_color_scheme_css_template' );
 ...
 * @see wp_add_inline_style()
 */
function liquidchurch_page_background_color_css() {
	$color_scheme          = liquidchurch_get_color_scheme();
	...
	wp_add_inline_style( 'liquidchurch-style', sprintf( $css, $page_background_color ) );
}
add_action( 'wp_enqueue_scripts', 'liquidchurch_page_background_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function liquidchurch_link_color_css() {
	$color_scheme    = liquidchurch_get_color_scheme();
	...
	wp_add_inline_style( 'liquidchurch-style', sprintf( $css, $link_color ) );
}
add_action( 'wp_enqueue_scripts', 'liquidchurch_link_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function liquidchurch_main_text_color_css() {
	$color_scheme    = liquidchurch_get_color_scheme();
	...
	wp_add_inline_style( 'liquidchurch-style', sprintf( $css, $main_text_color, $border_color ) );
}
add_action( 'wp_enqueue_scripts', 'liquidchurch_main_text_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function liquidchurch_secondary_text_color_css() {
	$color_scheme    = liquidchurch_get_color_scheme();
	...
	wp_add_inline_style( 'liquidchurch-style', sprintf( $css, $secondary_text_color ) );
}
add_action( 'wp_enqueue_scripts', 'liquidchurch_secondary_text_color_css', 11 );
