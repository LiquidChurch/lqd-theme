...
<div class="page">
    ...
    <div class="lqd-header container">
        <div class="lqd-header-covid row">
            <div class="col-xs-12 col-lg-9 text-center display-flex">
                <p class="lqd-header-covid-text"><strong>We're Meeting Online!</strong> All locations are gathering at Church Online this weekend.</p>
            </div>
            <div class="col-xs-12 col-lg-2 col-lg-offset-1 display-flex">
                <a class="btn lqd-header-covid-btn" href="https://liquidchurch.com/update">COVID-19 UPDATE</a>
            </div>
        </div>
